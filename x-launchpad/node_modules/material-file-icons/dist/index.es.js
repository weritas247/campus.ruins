var iconDefs = {
  icons: [
    ...
    },
    {
      ...
      files: [
        '.jscsrc',              '.jshintrc',
        'composer.lock',        '.jsbeautifyrc',
        '.esformatter',         'cdp.pid',
        '.lintstagedrc',        '.watchmanconfig',
        'tsconfig.tsbuildinfo', 'settings.json',
        'launch.json',          'tasks.json',
        'keybindings.json',     'extensions.json',
        'argv.json',            'profiles.json',
        'devcontainer.json',    '.devcontainer.json',
        'babel.config.json',    '.babelrc.json',
        '.ember-cli',           'typedoc.json',
    ...
    },
    {
      ...
      extensions: [
        ...
        'dtd',        'xsl',             'xslt',
        'resx',       'iml',             'xquery',
        'tmLanguage', 'manifest',        'project',
        'xml.dist',   'xml.dist.sample', 'dmn',
        'jrxml',      'ascx',            'atom',
        'axml',       'axaml',           'bpmn',
        'csl',        'csproj.user',     'dita',
        'ditamap',    'ent',             'mod',
        'dtml',       'fxml',            'isml',
        'jmx',        'launch',          'menu',
        'nuspec',     'opml',            'owl',
        'proj',       'pt',              'publishsettings',
        'pubxml',     'pubxml.user',     'rbxlx',
        'rbxmx',      'rdf',             'rng',
        'rss',        'shproj',          'storyboard',
        'targets',    'tld',             'tmx',
        'vbproj',     'vbproj.user',     'wsdl',
        'wxi',        'wxl',             'wxs',
        'xbl',        'xib',             'xlf',
        'xliff',      'xpdl',            'xul',
        'xoml'
    ...
    },
    {
      ...
      extensions: [
        ...
        'gbr',  'img',      'jbig2', 'jb2',
        'jng',  'jxr',      'pgf',   'pic',
        'raw',  'webp',     'eps',   'afphoto',
        'ase',  'aseprite', 'clip',  'cpt',
        'heif', 'heic',     'kra',   'mdp',
        'ora',  'pdn',      'reb',   'sai',
        'tga',  'xcf',      'jfif',  'ppm',
        'pbm',  'pgm',      'pnm'
    ...
    },
    {
      ...
      extensions: [
        ...
        'option',          'props',
        'toml',            'prefs',
        'sln.dotsettings', 'sln.dotsettings.user',
        'cfg',             'mak',
      ...
      files: [
        '.jshintignore', '.buildignore',
        '.mrconfig',     '.yardopts',
        'manifest.mf',   '.clang-format',
        '.clang-tidy',   'Makefile',
        'makefile',      'GNUmakefile',
        'OCamlMakefile', 'gitconfig',
        '.env'
      ]
    },
    {
    ...
    },
    {
      ...
      extensions: [
        ...
        'bat',          'cmd',          'awk',
        'fish',         'exp',          'bashrc',
        'bash_aliases', 'bash_profile', 'bash_login',
        'ebuild',       'profile',      'bash_logout',
        'xprofile',     'xsession',     'xsessionrc',
        'Xsession',     'zshrc',        'zprofile',
        'zlogin',       'zlogout',      'zshenv',
        'zsh-theme',    'cshrc',        'tcshrc',
        'yashrc',       'yash_profile'
      ],
      files: [
        'commit-msg',
    ...
    },
    {
      ...
      files: [
        'copying',        'copying.md',
        'copying.rst',    'copying.txt',
        'copyright',      'copyright.md',
        'copyright.rst',  'copyright.txt',
        'license',        'license-agpl',
        'license-apache', 'license-bsd',
        'license-mit',    'license-gpl',
        'license-lgpl',   'license.md',
        'license.rst',    'license.txt',
        'licence',        'licence-agpl',
        'licence-apache', 'licence-bsd',
        'licence-mit',    'licence-gpl',
        'licence-lgpl',   'licence.md',
        'licence.rst',    'licence.txt'
      ]
    },
    {
      name: 'key',
    ...
    },
    {
      ...
      extensions: [
        'spec.js',      'spec.cjs',
        'spec.mjs',     'e2e-spec.js',
        'e2e-spec.cjs', 'e2e-spec.mjs',
        'test.js',      'test.cjs',
        'test.mjs',     'js.snap',
        'cy.js'
      ]
    ...
    },
    {
      ...
      extensions: [
        'glsl',              'vert',          'tesc',
        'tese',              'geom',          'frag',
        'comp',              'vert.glsl',     'tesc.glsl',
        'tese.glsl',         'geom.glsl',     'frag.glsl',
        'comp.glsl',         'vertex.glsl',   'geometry.glsl',
        'fragment.glsl',     'compute.glsl',  'ts.glsl',
        'gs.glsl',           'vs.glsl',       'fs.glsl',
        'shader',            'vertexshader',  'fragmentshader',
        'geometryshader',    'computeshader', 'hlsl',
        'pixel.hlsl',        'geometry.hlsl', 'compute.hlsl',
        'tessellation.hlsl', 'px.hlsl',       'geom.hlsl',
        'comp.hlsl',         'tess.hlsl',     'wgsl',
        'hlsli',             'fx',            'fxh',
        'vsh',               'psh',           'cginc',
        'compute'
      ]
...
const defaultIcon = iconDefs.defaultIcon;
function getIcon(filename) {
    if (typeof filename === 'string') {
        ...
        iconDefs.icons.forEach(i => {
            var _a;
            return (_a = i.extensions) === null || _a === void 0 ? void 0 : _a.forEach(ext => ext.length > matchLength && lcFilename.endsWith('.' + ext) && (icon = i) && (matchLength = ext.length));
        });
        if (icon)
            return icon;
    }
...
export { defaultIcon, getAllIcons, getIcon };
